    ...
    public partial class FrmCliente : Form
    {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NPersona.Actualizar(Convert.ToInt32(TxtId.Text),"Cliente", TxtNombre.Text.Trim(), CboTipoDocumento.Text, this.NumDocumentoAnt,TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
